  ...
  <div class="section text-center">
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">
                <a href="./topics.php?id=3">Topics of Smalltalk </a>
              </li>
            </ol>
          </nav>
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <h4 class="topic_title mb-3">Topics of Smalltalk</h4>
            <div class="alert alert-danger my_alert mb-4" role="alert">
            Forum Rules Of the Smalltalk Board
            </div>
...
$sql = "select topics.title as topicTitle,topics.id as topicId, topics.modification_date as topicModificationDate, users.nickname as topicBy from topics INNER JOIN users on topic_by = users.id  where board_id = '3' order by topicModificationDate DESC";
